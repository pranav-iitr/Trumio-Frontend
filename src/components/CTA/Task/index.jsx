...
export default function Index() {
  ...
  return (
    <>
      <h1 className="text-[2.2vw] px-[5vw] mt-32 text-[#515151] font-bold font-[lato]">
      ...
      <div className="w-[100vw] w-[90rem] px-[5vw] h-[30rem] flex justify-center mt-14 ">
        ...
        <div className="flex-[0.75] font-[Be Vietnam Pro] flex flex-col gap-5 overflow-y-scroll justify-start items-start px-8 py-4">
          ...
          <div className="text-[#383838] font-light">
            ...
            libero. Sed cursus ante dapibus diam. Sed Lorem ipsum dolor sit
            amet, consectetur adipiscing elit. Integer nec odio. Praesent
            libero. Sed cursus ante dapibus diam. Sed Integer nec odio. Praesent
