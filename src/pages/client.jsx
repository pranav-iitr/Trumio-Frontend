...
import LineChart1 from "@/components/Client/lineChart1.js";
import LineChart2 from "@/components/Client/lineChart2.js";
import Side from "@/components/SideNavbar/Desktop";
      ...
      <div className="w-[85vw] flex-col flex h-[auto] pl-[28px] pr-[40px] bg-[#F5FBFF;]">
          ...
          <div className="flex gap-x-4 items-center">
            <div className=" border-solid border-">
              <input
                ...
                className="w-[20rem] h-[3rem] rounded-lg px-3"
              />
            </div>
            <div>
            ...
            <div>
              <img src="/imgs/sampleuser.png" alt="usericon" />
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center w-[72vw] justify-between pt-[40px] pb-[20px]">
            <div className="font-bold text-xl">Courses Info</div>
            <div>
              <button className="h-[42px] w-[120px] bg-[#318EFF] text-[white] font-bold rounded-lg">
                + Add course{" "}
              </button>
            </div>
          </div>
                ...
                {Random.map((data) => {
                  return (
                    <>
                      <div
                        key={data.id}
                        className="mx-10 h-[5.5vh] justify-between items-center flex "
                      >
                        <div>{data.course_name}</div>
                        <div className="ml-[2vw]">
                          {data.no_of_registrations}
                        </div>
                        <div className="ml-[11.6vw]">
                          {data.no_of_completions}
                        </div>
                        <div className="ml-[6vw] text-[#318EFF] underline">
                          <a href={data.view}>view</a>
                        </div>
                        <div>
                          <button className="w-[6rem] h-[1.7rem] bg-[#E63838]/10 rounded-lg font-bold text-[#E63838]">
                            delete
                          </button>{" "}
                        </div>
                      </div>
        ...
        <div className="flex justify-between w-[72vw] mt-[40px]">
          <div className="flex flex-col">
            <div className="font-bold text-xl">Course completion rate</div>
